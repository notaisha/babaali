...
for (row, col), cell in table.get_celld().items():
    if row > 0 and col > 0:  # Skip header row and column (row=0, col=0 are headers)
        cell.set_fontsize(font_size)  # Adjust the font size as needed
        cell.set_text_props(fontweight='bold')  # Set the font family
